...
- Request summary: Expand billing coverage for workload 12.
...
Introduce billing delivery slice 12 for the dense portfolio fixture.
...
Feature feature-12 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect billing feature 12 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-12 under v2.
...
- feature-12 appears in feature-index.json and matching markdown exists.
