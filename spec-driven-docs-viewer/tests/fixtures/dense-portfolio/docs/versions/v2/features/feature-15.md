# Feature: Platform Capability 15
...
- Request summary: Expand platform coverage for workload 15.
...
Introduce platform delivery slice 15 for the dense portfolio fixture.
...
Feature feature-15 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect platform feature 15 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-15 under v2.
...
- feature-15 appears in feature-index.json and matching markdown exists.
