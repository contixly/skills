# Feature: Delivery Capability 18
...
- Request summary: Expand delivery coverage for workload 18.
...
Introduce delivery delivery slice 18 for the dense portfolio fixture.
...
Feature feature-18 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect delivery feature 18 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-18 under v2.
...
- feature-18 appears in feature-index.json and matching markdown exists.
