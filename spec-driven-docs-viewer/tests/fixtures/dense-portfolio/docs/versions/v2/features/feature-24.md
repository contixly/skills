...
- Request summary: Expand review coverage for workload 24.
...
Introduce review delivery slice 24 for the dense portfolio fixture.
...
Feature feature-24 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect review feature 24 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-24 under v2.
...
- feature-24 appears in feature-index.json and matching markdown exists.
