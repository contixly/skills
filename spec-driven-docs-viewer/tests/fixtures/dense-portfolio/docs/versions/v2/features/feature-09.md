...
- Request summary: Expand intake coverage for workload 9.
...
Introduce intake delivery slice 9 for the dense portfolio fixture.

## 2. Business case

### 2.1 Business goals

Give the viewer realistic intake entries with varied status and dependency metadata.
...
Feature feature-09 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect intake feature 9 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-09 under v2.
...
- feature-09 appears in feature-index.json and matching markdown exists.
