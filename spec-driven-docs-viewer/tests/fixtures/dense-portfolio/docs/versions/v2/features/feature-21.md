...
- Request summary: Expand support coverage for workload 21.
...
Introduce support delivery slice 21 for the dense portfolio fixture.
...
Feature feature-21 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect support feature 21 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-21 under v2.
...
- feature-21 appears in feature-index.json and matching markdown exists.
