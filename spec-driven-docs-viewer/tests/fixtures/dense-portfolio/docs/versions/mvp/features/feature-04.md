...
- Request summary: Expand delivery coverage for workload 4.
...
Introduce delivery delivery slice 4 for the dense portfolio fixture.
...
Feature feature-04 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect delivery feature 4 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-04 under mvp.
...
- feature-04 appears in feature-index.json and matching markdown exists.
