...
- Request summary: Expand billing coverage for workload 19.
...
Introduce billing delivery slice 19 for the dense portfolio fixture.
...
Feature feature-19 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect billing feature 19 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-19 under mvp.
...
- feature-19 appears in feature-index.json and matching markdown exists.
