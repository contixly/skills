...
- Request summary: Expand platform coverage for workload 1.
...
Introduce platform delivery slice 1 for the dense portfolio fixture.
...
Feature feature-01 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect platform feature 1 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-01 under mvp.
...
- feature-01 appears in feature-index.json and matching markdown exists.
