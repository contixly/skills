...
- Request summary: Expand intake coverage for workload 16.
...
Introduce intake delivery slice 16 for the dense portfolio fixture.
...
Feature feature-16 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect intake feature 16 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-16 under mvp.
...
- feature-16 appears in feature-index.json and matching markdown exists.
