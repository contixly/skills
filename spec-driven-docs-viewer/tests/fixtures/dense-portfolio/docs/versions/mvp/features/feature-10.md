...
- Request summary: Expand review coverage for workload 10.
...
Introduce review delivery slice 10 for the dense portfolio fixture.
...
Feature feature-10 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect review feature 10 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-10 under mvp.
...
- feature-10 appears in feature-index.json and matching markdown exists.
