...
- Request summary: Expand platform coverage for workload 8.
...
Introduce platform delivery slice 8 for the dense portfolio fixture.
...
Feature feature-08 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect platform feature 8 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-08 under v1.
...
- feature-08 appears in feature-index.json and matching markdown exists.
