...
- Request summary: Expand intake coverage for workload 23.
...
Introduce intake delivery slice 23 for the dense portfolio fixture.
...
Feature feature-23 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect intake feature 23 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-23 under v1.
...
- feature-23 appears in feature-index.json and matching markdown exists.
