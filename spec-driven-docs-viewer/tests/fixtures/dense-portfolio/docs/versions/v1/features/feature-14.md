...
- Request summary: Expand support coverage for workload 14.
...
Introduce support delivery slice 14 for the dense portfolio fixture.
...
Feature feature-14 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect support feature 14 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-14 under v1.
...
- feature-14 appears in feature-index.json and matching markdown exists.
