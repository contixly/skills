...
- Request summary: Expand review coverage for workload 17.
...
Introduce review delivery slice 17 for the dense portfolio fixture.
...
Feature feature-17 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect review feature 17 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-17 under v1.
...
- feature-17 appears in feature-index.json and matching markdown exists.
