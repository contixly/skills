...
- Request summary: Expand intake coverage for workload 2.
...
Introduce intake delivery slice 2 for the dense portfolio fixture.
...
Feature feature-02 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect intake feature 2 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-02 under v1.
...
- feature-02 appears in feature-index.json and matching markdown exists.
