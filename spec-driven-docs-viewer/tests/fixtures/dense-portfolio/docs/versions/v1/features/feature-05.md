...
- Status: blocked
- Priority: medium
- Depends on: feature-01, feature-02

## 0. Incoming request

- Source: planning review
- Request summary: Expand billing coverage for workload 5.
...
Introduce billing delivery slice 5 for the dense portfolio fixture.

## 2. Business case

### 2.1 Business goals

Give the viewer realistic billing entries with varied status and dependency metadata.
...
Feature feature-05 is indexed and linked across docs, packets, and delivery state.

## 4. Functional requirements

### 4.1 User stories

- As a maintainer, I can inspect billing feature 5 in the viewer.

### 4.2 Functional scenarios

- Viewer groups packets for feature-05 under v1.
...
- feature-05 appears in feature-index.json and matching markdown exists.
